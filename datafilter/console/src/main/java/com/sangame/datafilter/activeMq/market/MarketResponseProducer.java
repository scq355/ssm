 ...
 */
@Component
public class MarketResponseProducer extends BaseResponseProducer{

    @Autowired
    @Qualifier("marketResponseQueueDestination")
    Destination destination;

    @Async
    public void sendMessage(final String message, boolean exceptionDealFlag) {
       super.sendMessage(destination,message, ConsoleConstant.ProjectType.MARKET.getValue(),exceptionDealFlag);
    }
}
